...
const ExampleModal = ({ onClose, closeExampleButton, exampleImage, modalExampleOpen,icon }) => {
      ...
      <View style={container}>
        ...
        <TouchableOpacity style={styles.returnButtonView} onPress={onClose} >
          <View >
            ...
            <MatetrialCommunityIcons style={styles.iconStyles} name={icon} color="#EFA600" size={26} />
          </View>
        </TouchableOpacity>
        {/*Image and heading*/}
