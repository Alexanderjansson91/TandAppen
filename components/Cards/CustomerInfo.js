    ...
    return (
        <View style={viewContainer}>
            ...
            <View style={styles.parent}>
                <MatetrialCommunityIcons name={props.iconName} style={styles.iconStyle} />
                <Text style={infoText}>{props.costumerName}</Text>
            </View>
            <View style={styles.underline} />
            <View style={styles.parent}>
                <MatetrialCommunityIcons name={props.iconEmail} style={styles.iconStyle} />
                <Text style={infoText}>{props.costumerEmail}</Text>
            </View>
            <View style={styles.underline} />
            <View style={styles.parent}>
                <MatetrialCommunityIcons name={props.iconPhone} style={styles.iconStyle} />
                <Text style={infoText}>{props.costumerPhone}</Text>
            </View>
            <View style={styles.underline} />
            <View style={styles.parent}>
                <MatetrialCommunityIcons name={props.iconMessage} style={styles.iconStyle} />
                <Text style={infoText}>{props.costumerMessage}</Text>
            </View>
            <View style={styles.underline} />
            <View style={styles.parent}>
                <MatetrialCommunityIcons name={props.iconYear} style={styles.iconStyle} />
